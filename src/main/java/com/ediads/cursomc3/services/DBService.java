...
import com.ediads.cursomc3.domain.Cidade;
...
import com.ediads.cursomc3.domain.PagamentoComCartao;
...
import com.ediads.cursomc3.repositories.EnderecoRepository;
import com.ediads.cursomc3.repositories.EstadoRepository;
...
import com.ediads.cursomc3.repositories.ProdutoRepository;
...
public void instantiateTestDatabase() throws ParseException {
	...
	Produto p9 = new Produto(null, "Aajur", 100.00);
	...
	Cliente cli1 = new Cliente(null, "MariaSilva", "ecarlos.leite@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA);
	...
	itenPedidoRepository.saveAll(Arrays.asList(ip1,ip2,ip3));
